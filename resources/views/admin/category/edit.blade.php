...
@section('title')
Edit Category {{$category->category_name}} - {{ config('app.name', 'Laravel') }}
@endsection
@section('content')
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="{{route('category.index')}}" class="btn add-btn"><i class="fa fa-plus"></i>View All Category</a>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <select name="parent_id" id="parent_id" class="form-control">
                                          ...
                                          <option value="{{$data->id}}"@if ($data->id == $category->parent_id) selected
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-check" data-children-count="1">
                                            <input class="form-check-input" type="checkbox" name="status" value="1" id="status" @if ($category->status==1)checked
                                            @else
