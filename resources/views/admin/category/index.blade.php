...
@section('title')
All Categories - {{ config('app.name', 'Laravel') }}
@endsection
...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">View All Category</h3>
                    <ul class="breadcrumb">
                            ...
                            <table class="datatable table table-stripped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('category.edit',$category->id)}}" class="btn btn-info btn-sm"><i class="la la-edit"></i></a>
