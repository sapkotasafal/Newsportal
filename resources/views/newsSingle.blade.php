...
<div class="blog-single-gallery grey-bg">
    <div class="auto-container">
        <div class="image">
            <img src="{{asset('/storage/uploads/'.$news_detail['image'])}}" alt="" />
        </div>
    </div>
</div>
<!--End Single Gallery-->
                    ...
                    <div class="blog-single">
                        <div class="inner-box">
                            <div class="upper-box">
                                ...
                                <ul class="social-icon-one alternate">
                                    ...
                                    <div class="addthis_inline_share_toolbox_stof"></div>
                        ...
                        <div class="author-box">
                            <div class="author-comment">
                                <div class="inner-box">
                                    <div class="image"><img src="{{asset('/storage/uploads/'.$news_detail->admin['image'])}}" alt="" /></div>
                        ...
                        <div class="related-posts">
                            ...
                            <div class="related-item-carousel owl-carousel owl-theme">
                                ...
                                <div class="news-block-two small-block">
                                    <div class="inner-box">
                                        <div class="image">
                                            <a href="{{route('newsSingle',$data->slug)}}"><img src="{{asset('/storage/uploads/'.$data['image'])}}" alt="" /></a>
...
<script>
    ...
    */
    ...
    s.src = 'https://newsportal-7.disqus.com/embed.js';
